...
namespace CineWorld.Services.ReactionAPI.Services
{
    public class CommentService : ICommentService
    {
        ...
        private readonly string _userServiceUrl = "https://localhost:7000/api/users/GetUserInformationById";
        private readonly IHttpClientFactory _httpClientFactory;
        public CommentService(IUnitOfWork unitOfWork, IMapper mapper, IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<PagedList<CommentDTO>> GetCommentByMovieIdAsync(int movieId, CommentParam reqParams)
        {
            ...
            var finalUrl = $"{_userServiceUrl}?{queryString}";
